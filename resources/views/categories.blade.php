                        ...
                        <div class="tt-item">
                            <div class="tt-item-header">
                                <ul class="tt-list-badge">
                                    <li><a href="{{url('category/'.$category->name)}}"><span class="tt-color0{{$i++}} tt-badge">{{$category->name}}</span></a></li>
                                </ul>
                                <h6 class="tt-title"><a href="{{url('category/'.$category->name)}}">Threads - {{$category->count}}</a></h6>
                            </div>
